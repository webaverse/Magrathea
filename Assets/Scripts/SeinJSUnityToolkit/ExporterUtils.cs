...
namespace SeinJS
{
    public class ExporterUtils
    {
        ...
        private static Texture2D GenerateBakedDiffuse(Texture2D tex, Texture2D lightmapTex, UnityEngine.Mesh mesh, Renderer renderer)
        {
            ...
            ComputeShader combiner = AssetDatabase.LoadAssetAtPath<ComputeShader>(@"Assets/Magrathea/Code/Shaders/LightmapCombineBaker.compute");
        ...
        public static string[] GetAssetOutPath(UnityEngine.Object assetObject, string format = null)
        {
            ...
            {
                assetPath = Path.Combine(PipelineSettings.ConversionFolder, assetObject.GetInstanceID() + "_" + System.DateTime.Now.ToBinary().ToString() + ".tga");
