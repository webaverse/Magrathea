...
namespace Magrathea
{
    public class ExportScene : EditorWindow
    {
        ...
        State state;
        bool doDebug;
        string defaultMatPath = @"Assets/Magrathea/Materials/Block.mat";
        string nullMatPath = @"Assets/Magrathea/Materials/Null.mat";
            ...
            switch (state)
            {
                ...
                case State.INITIAL:
                    ...
                    if (showOptimization)
                    {
                        ...
                        PipelineSettings.CombineNodes = EditorGUILayout.Toggle("Combine Nodes (breaks Magrathea components)", PipelineSettings.CombineNodes);
                        GUILayout.Space(16);
