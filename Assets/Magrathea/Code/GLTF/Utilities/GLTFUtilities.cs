    ...
    public class GLTFUtilities
    {
        ...
        static ComputeShader FastMapper
        {
            get
            {
                if(_fastMapper == null)
                {
                    _fastMapper = AssetDatabase.LoadAssetAtPath<ComputeShader>(@"Assets/Magrathea/Code/Shaders/FastMap.compute");
                }
                return _fastMapper;
            }
        }
        private const string _whiteTexPath = @"Assets/Magrathea/Code/GLTF/Utilities/WhiteTex.png";
        ...
        private const string _blackTexPath = @"Assets/Magrathea/Code/Utilities/BlackTex.png";
